...
import { initDatabase, getChannelsByLanguage } from '@/services/database';

export default function LanguageChannels() {
    ...
    const loadChannels = async () => {
        try {
            await initDatabase();
            const data = await getChannelsByLanguage(id as string);
            setChannels(data);
        } catch (error) {
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View className="flex-1 justify-center items-center mt-10">
                            <Text>No channels found in this language.</Text>
                        </View>
                    }
                />
            )}
