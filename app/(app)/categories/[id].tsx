...
import { initDatabase, getChannelsByCategory } from '@/services/database';

export default function CategoryChannels() {
    ...
    const loadChannels = async () => {
        try {
            await initDatabase();
            const data = await getChannelsByCategory(id as string);
            setChannels(data);
        } catch (error) {
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View className="flex-1 justify-center items-center mt-10">
                            <Text>No channels found in this category.</Text>
                        </View>
                    }
                />
            )}
